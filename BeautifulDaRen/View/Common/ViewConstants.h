...
#define NAVIGATION_LEFT_LOGO_WIDTH (100.0)
#define NAVIGATION_LEFT_LOGO_HEIGHT (25.0)
...
#define USERDEFAULT_LOGIN_ACCOUNT_USERNAME @"USERDEFAULT_LOGIN_ACCOUNT_USERNAME"
